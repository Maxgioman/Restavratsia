...
namespace restavratsia1.Migrations
{
    ...
    [Migration("20200405194559_AddIdentityUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("restavratsia1.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("restavratsia1.Models.CompanyHasSpecialization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyId")
                        .HasName("fk_company_has_specialization_company1_idx");

                    b.HasIndex("SpecializationSpecialization")
                        .HasName("fk_company_has_specialization_specialization1_idx");

                    b.ToTable("company_has_specialization");
                });
            ...
            modelBuilder.Entity("restavratsia1.Models.CompanyReview", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasName("fk_company_review_company1_idx");
            ...
            modelBuilder.Entity("restavratsia1.Models.Specialization", b =>
                {
            ...
            modelBuilder.Entity("restavratsia1.Models.CompanyHasSpecialization", b =>
                {
                    b.HasOne("restavratsia1.Models.Company", "Company")
                        .WithMany("CompanyHasSpecialization")
                        .HasForeignKey("CompanyId")
                        .HasConstraintName("fk_company_has_specialization_company1")
                        .IsRequired();

                    b.HasOne("restavratsia1.Models.Specialization", "SpecializationSpecializationNavigation")
                        .WithMany("CompanyHasSpecialization")
                        .HasForeignKey("SpecializationSpecialization")
                        .HasConstraintName("fk_company_has_specialization_specialization1")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("restavratsia1.Models.CompanyReview", b =>
                {
                    b.HasOne("restavratsia1.Models.Company", "Company")
                        ...
                        .HasForeignKey("CompanyId")
                        .HasConstraintName("fk_company_review_company1")
                        .IsRequired();
            ...
            modelBuilder.Entity("restavratsia1.Models.Custom", b =>
                {
                    b.HasOne("restavratsia1.Models.Company", "FinalCompany")
                        .WithMany("Custom")
                        .HasForeignKey("FinalCompanyId")
                        .HasConstraintName("final_company_id")
                        .OnDelete(DeleteBehavior.Cascade);
