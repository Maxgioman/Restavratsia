...
class SignIn extends Component {
  render() {
    return (
      <section
        id="login-section"
        className="section xxs-section-height-1_25x md-section-height-1_125x"
      >
        <div
          id="login-container"
        ...
        >
          <div className="form">
            <div id="login-choose" className="choosing">
              <Link
                to={"/sign-in/as-customer"}
                id="login-customer-btn"
                className="button-class"
              >
                <p>Customer</p>
              </Link>
              <Link
                to={"/sign-in/as-company"}
                id="login-company-btn"
                className="button-class"
              >
                <p>Company</p>
              </Link>
            ...
            <Switch>
              ...
              <Route path={"/sign-in"}>
                <div id="div-choose" className="flex-center">
                  <h1 id="zahlushka" className="text">
